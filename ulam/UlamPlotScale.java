...
public class UlamPlotScale extends JFrame { //change the name of class to match the name of the java file
   ...
   public void paint( Graphics g )
   {
	...
	g.setColor(new Color(0,64,0));	g.fillRect(0,23,800,800);
	...
	// code from the tty debug
		...
		//System.out.println("n:"+n+" x:"+x+" y:"+y+" h:"+h+" k:"+k+" nlogic "+nlogic+" parity:"+parity);
			...
			g.fillRect(h+400,422-k,scale,scale);
		...
		for (e = 1;e < 1000;e++){
			...
			for (x = 0; x < e; x++){
				g.setColor(new Color(255,255,255));
				g.drawRect(h+400,422-k,scale,scale);
				h = h + (parity*scale);
					n++;
		...
		checkPrime = is.isprime(n);
				...
				//	System.out.print (modPrimes+" ");
					...
					//g.drawLine(h+400,400-k,h+400,400-k);
					g.fillRect(h+400,422-k,scale,scale);
						//		g.setColor(new Color(255,127,0));	g.fillRect(200,30,10,800);
						//			g.setColor(new Color(255,64,0));	g.fillRect(210,25,10,800);
						//			g.setColor(new Color(255,32,0));	g.fillRect(220,23,10,800);
						//			g.setColor(new Color(255,16,0));	g.fillRect(230,22,10,800);
				}
			}
