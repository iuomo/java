...
/* 
<applet name="n" code="Newton" width=900 height=900>
<param name=rStart value=0>
<param name=gStart value=127>
<param name=bStart value=0>

<param name=rEnd value=127>
<param name=gEnd value=0>
<param name=bEnd value=127>
...
g.drawString(" r 1 : "+ired, 810,400);
g.drawString(" g 1 : "+igreen, 810,420);
g.drawString(" b 1 : "+iblue, 810,440);
g.drawString(" r 2 : "+iradj, 810,460);
g.drawString(" g 2 : "+igadj, 810,480);
g.drawString(" b 2 : "+ibadj, 810,500);
